...
finnish.RebaseTitle=Cygwin yll�pito
...
finnish.CreateStartMenu=Lis�� aloitusvalikkoon
finnish.CreateCygwinStartMenu=Lis�� Cygwin-setup aloitusvalikkoon
...
finnish.CygwinUninstallNotice=Cygwin-asennusta (ja indeksitiedostoja) %1 hakemistossa ei poistettu, koska se voi olla muiden ohjelmien k�yt�ss�. Voit tuhota %1 -hakemiston mik�li et tarvitse Cygwini� mihink��n.
...
finnish.CygwinUninstallNoticeNoDir=Cygwin-asennusta (ja indeksitiedostoja) ei poistettu, koska se voi olla muiden ohjelmien k�yt�ss�. Voit tuhota Cygwin -hakemiston mik�li et tarvitse Cygwini� mihink��n.
...
Name: "{group}\K�ytt�ohje (Finnish)"; Filename: "{app}\docs\AstroTortilla_kayttoohje.pdf"; Tasks: startmenu
