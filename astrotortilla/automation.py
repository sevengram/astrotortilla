...
and pywinauto -project (LGPL license).

The keyboard event sending is language and keyboard layout sensitive for many
non-alnum character, such as colon, forwardslash and backslash.

TODO: mouse event sending
"""
import time
import ctypes
...
class PauseAction(KeyAction):
    ...
    def __str__(self):
        return "<PauseAction %1.2f>"% (self.how_long)
    __repr__ = __str__
