...
PROPERTYLIST = {
    ...
    "configfile": (
        _("Backend config"), str, _("Cygwin path to backend config file"), "", "/etc/astrometry/backend.cfg"),
    ...
    "scale_units": (
        _("Scale units"), str, _("View scale size units"), _("arcminwidth, degwidth, arcsecperpix"), "degwidth"),
